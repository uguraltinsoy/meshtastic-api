...
app.get('/nodes/:nodeId', async (req, res) => {
    try {
...
app.get('/nodes/:nodeId/device-metrics', async (req, res) => {
    try {
...
app.get('/nodes/:nodeId/environment-metrics', async (req, res) => {
    try {
...
app.get('/nodes/:nodeId/power-metrics', async (req, res) => {
    try {
...
app.get('/nodes/:nodeId/mqtt-metrics', async (req, res) => {
    try {
...
app.get('/nodes/:nodeId/neighbours', async (req, res) => {
    try {
...
app.get('/nodes/:nodeId/traceroutes', async (req, res) => {
    try {
...
app.get('/nodes/:nodeId/position-history', async (req, res) => {
    try {
...
app.get('/stats/hardware-models', async (req, res) => {
    try {
...
app.get('/text-messages', async (req, res) => {
    try {
